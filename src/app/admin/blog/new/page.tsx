  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setTimeout(() => {
          router.push("/admin/dashboard?success=created")
        }, 2000)
      } else {
        setError(result.error || "Blog oluşturulurken bir hata oluştu")
      }
    } catch (error) {
              ...
              <Card>
                <CardHeader>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Blog yazınızın temel bilgilerini girin. SEO alanları otomatik doldurulacak.
                  </p>
                </CardHeader>
                ...
                <div className="space-y-6">
                  <Card>
                    <CardHeader>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Bu alanlar temel bilgilerden otomatik doldurulur, ancak özelleştirebilirsiniz.
                      </p>
                    </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="text-xs text-muted-foreground">
                      {metaTitle.length}/60 karakter • {title && !metaTitle ? 'Blog başlığından otomatik' : 'Özelleştirilmiş'}
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <div className="text-xs text-muted-foreground">
                      {metaDescription.length}/160 karakter • {excerpt && !metaDescription ? 'Kısa açıklamadan otomatik' : 'Özelleştirilmiş'}
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="text-xs text-muted-foreground">
                      {tags.length > 0 && metaKeywords.length === 0 ? 'Etiketlerden otomatik senkronize' : 'Özelleştirilmiş'}
                    </div>
                  </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    />
                    <div className="text-xs text-muted-foreground">
                      {title && !ogTitle ? 'Blog başlığından otomatik' : 'Özelleştirilmiş'}
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <div className="text-xs text-muted-foreground">
                      {excerpt && !ogDescription ? 'Kısa açıklamadan otomatik' : 'Özelleştirilmiş'}
                    </div>
                  </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    />
                    <div className="text-xs text-muted-foreground">
                      {title && !twitterTitle ? 'Blog başlığından otomatik' : 'Özelleştirilmiş'}
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <div className="text-xs text-muted-foreground">
                      {excerpt && !twitterDescription ? 'Kısa açıklamadan otomatik' : 'Özelleştirilmiş'}
                    </div>
                  </div>
